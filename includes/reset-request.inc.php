...
if (isset($_POST["reset-request-submit"])) {
    ...
    $message = '<p>We received a password reset request. You can find the link to reset your password bellow. If you did not make this request, you can safely ignore this email.</p>';
